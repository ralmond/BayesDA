...
The [negative binomial distribution](https://en.wikipedia.org/wiki/Negative_binomial_distribution) can be thought of as a number of draws of non-black balls, $x$, from an urn with a proportion $p$ of black balls, until $r$ black balls have been drawn.  When $r=1$, it is known as the _geometric distribution_
...
renderPlot({
  ...
  n <- qnbinom(.995,r,p)
  dat <- data.frame(x=0:n,y=dnbinom(0:n,n,p))
