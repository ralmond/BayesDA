...
[Law Of Large Numbers](https://pluto.coe.fsu.edu/LawOfLargeNumbers.Rmd)

[Law Of Large Numbers (Animated)](https://pluto.coe.fsu.edu/LawOfLargeNumbersAnimated.Rmd)
...
A _statistic_ is a _functional_ which maps a distribution function to a summary.

A _function_ is an operator which maps a function to a (real) value.
...
* Instead think of choins random point in a histogram
